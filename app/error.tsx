    ...
    switch (type) {
      ...
      case 'database':
        return {
          ...
          description: 'We\'re experiencing issues with our database. Our team has been notified and is working to fix this.',
          icon: <Bug className="w-12 h-12 text-red-500" />
        }
      case 'authentication':
        return {
          title: 'Authentication Error',
          description: 'There was an issue with your login session. Please sign in again to continue.',
      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          >
            ...
            <span className="font-medium text-gray-700 group-hover:text-primary-600">Sign In</span>
          </Link>
          ...
          >
            ...
            <span className="font-medium text-gray-700 group-hover:text-primary-600">Get Help</span>
          </Link>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
          ...
          <div className="space-y-2 text-sm text-left">
            <div className="flex items-start">
              ...
              <span className="text-gray-700">Refresh the page and try again</span>
            </div>
            <div className="flex items-start">
              <span className="text-primary-600 mr-2">2.</span>
              <span className="text-gray-700">Clear your browser cache and cookies</span>
            </div>
            <div className="flex items-start">
              <span className="text-primary-600 mr-2">3.</span>
              <span className="text-gray-700">Try using a different browser</span>
            </div>
            <div className="flex items-start">
